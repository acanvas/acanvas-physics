...
class TestBuoyancy extends Test {
  ...
  TestBuoyancy(Stopwatch w) : super(w) {
    ...
    for (i = 0; i < 5; i++) {
      ...
      fd.restitution = 0.1;
      boxDef.SetAsBox(
          (new Random().nextDouble() * 5 + 10) / m_physScale, (new Random().nextDouble() * 5 + 10) / m_physScale);
      bodyDef.position.Set(
          (new Random().nextDouble() * 400 + 120) / m_physScale, (new Random().nextDouble() * 150 + 50) / m_physScale);
    ...
    for (body in m_bodies) m_controller.AddBody(body);
