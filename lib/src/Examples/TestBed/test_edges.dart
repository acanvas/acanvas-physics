...
*/
 ...
 part of stagexl_box2d;
	 ...
	 TestEdges(){
			...
			// Set Text field
			Main.m_aboutText.text = "Edge Chains";
			
			b2PolygonDef box = new b2PolygonDef();
			...
			for (i = 0; i < 10; i++){
				...
				bd.position.Set((640/2+200+new Random().nextDouble()*0.02 - 0.01) / m_physScale, (360-5-i*25) / m_physScale);
			...
			// Create ball
			b2CircleDef cd = new b2CircleDef();
		 ...
		 void Update(){
			...
			segment.p2.SetV(laser.GetWorldListnew b2Vec2(100/m_physScale,0)))
			segment.p2.Add(segment.p1);
			
			List lambdaRef=[1];
			b2Vec2 normal=new b2Vec2();
			b2Shape shape = m_world.RaycastOne(segment,lambdaRef,normal,true,null);
			
			double lambda = lambdaRef[0];
