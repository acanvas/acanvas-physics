...
*/
 ...
 class b2Vec2
{
	  b2Vec2([double x_=0.0, double y_=0.0]) {x=x_; y=y_;}

	  void SetZero() { x = 0.0; y = 0.0; }
	  void Set([double x_=0.0, double y_=0.0]) {x=x_; y=y_;}
	  void SetV(b2Vec2 v) {x=v.x; y=v.y;}

	  b2Vec2 GetNegative() { return new b2Vec2(-x, -y); }
	  void NegativeSelf() { x = -x; y = -y; }
