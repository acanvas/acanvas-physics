 ...
 class b2DynamicTreeBroadPhase implements IBroadPhase
{
	  ...
	  void UpdatePairs(Function callback)
	{
		...
		for(b2DynamicTreeNode queryProxy in m_moveBuffer)
		{
			 bool QueryCallback(b2DynamicTreeNode proxy)
			{
				...
				pair.proxyA = (proxy.key  < queryProxy.key)?proxy:queryProxy;
				pair.proxyB = (proxy.key >= queryProxy.key)?proxy:queryProxy;
				++m_pairCount;
