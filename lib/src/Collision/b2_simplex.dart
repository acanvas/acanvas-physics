	 ...
	 b2Simplex()
{
  ...
  void ReadCache(b2SimplexCache cache,b2DistanceProxy proxyA,b2Transform transformA,b2DistanceProxy proxyB,b2Transform transformB)
{
	...
	m_count = cache.count;
	List<b2SimplexVertex> vertices = m_vertices;
	b2SimplexVertex v;
  ...
  void WriteCache(b2SimplexCache cache)
{
	cache.metric = GetMetric();
	cache.count = (m_count).toInt();
	List<b2SimplexVertex> vertices = m_vertices;
	for (int i = 0; i < m_count; i++)
	{
  ...
  b2Vec2 GetClosestPoint()
{
  ...
  void GetWitnessPoints(b2Vec2 pA,b2Vec2 pB)
{
	switch(m_count)
	{
		case 0:
  ...
  void Solve3()
{
	...
	// a3 = 0
	b2Vec2 e12 = b2Math.SubtractVV(w2, w1);
	double w1e12 = b2Math.Dot(w1, e12);
	double w2e12 = b2Math.Dot(w2, e12);
	double d12_1 = w2e12;
	double d12_2 = -w1e12;
	...
	double w1e13 = b2Math.Dot(w1, e13);
	double w3e13 = b2Math.Dot(w3, e13);
	double d13_1 = w3e13;
	double d13_2 = -w1e13;
	...
	double w2e23 = b2Math.Dot(w2, e23);
	double w3e23 = b2Math.Dot(w3, e23);
	double d23_1 = w3e23;
	double d23_2 = -w2e23;
	
	// Triangle123
	double n123 = b2Math.CrossVV(e12, e13);

	double d123_1 = n123 * b2Math.CrossVV(w2, w3);
	double d123_2 = n123 * b2Math.CrossVV(w3, w1);
	double d123_3 = n123 * b2Math.CrossVV(w1, w2);
 ...
 b2SimplexVertex m_v1 = new b2SimplexVertex();
