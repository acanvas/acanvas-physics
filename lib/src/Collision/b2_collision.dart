...
*/
 class b2Collision{
	...
	static   double EdgeSeparation(b2PolygonShape poly1,b2Transform xf1,int edge1,b2PolygonShape poly2,b2Transform xf2)
	{
	...
	// from poly1.
	static   double FindMaxSeparation(List<int> edgeIndex,b2PolygonShape poly1,b2Transform xf1,b2PolygonShape poly2,b2Transform xf2)
	{
		int count1 = poly1.m_vertexCount;
		List<b2Vec2> normals1 = poly1.m_normals;
	...
	static   void FindIncidentEdge(List<ClipVertex> c,b2PolygonShape poly1,b2Transform xf1,int edge1,b2PolygonShape poly2,b2Transform xf2)
	{
		int count1 = poly1.m_vertexCount;
		List<b2Vec2> normals1 = poly1.m_normals;
	...
	static   void CollidePolygons(b2Manifold manifold,b2PolygonShape polyA,b2Transform xfA,b2PolygonShape polyB,b2Transform xfB)
	{
		ClipVertex cv;
	...
	static   void CollideCircles(b2Manifold manifold,b2CircleShape circle1,b2Transform xf1,b2CircleShape circle2,b2Transform xf2)
	{
		manifold.m_pointCount = 0;
	...
	static   void CollidePolygonAndCircle(b2Manifold manifold,b2PolygonShape polygon,b2Transform xf1,b2CircleShape circle,b2Transform xf2)
	{
		manifold.m_pointCount = 0;
