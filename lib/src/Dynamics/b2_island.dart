...
position error is re-computed for constraint and the positions are updated
...
joint separation can be problematic. The doubleber of NGS iterations can be reduced
