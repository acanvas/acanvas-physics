 ...
 class b2Joint
{
	...
	*/
	 b2Vec2 GetAnchorA(){return null;}
	/**
	* Get the anchor point on bodyB in world coordinates.
	*/
	 b2Vec2 GetAnchorB(){return null;}
	
	/**
	* Get the reaction force on body2 at the joint anchor in Newtons.
	*/
	 b2Vec2 GetReactionForce(double inv_dt) {return null;}
	/**
	* Get the reaction torque on body2 in N*m.
	*/
	 double GetReactionTorque(double inv_dt) {return 0.0;}
